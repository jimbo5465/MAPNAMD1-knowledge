...
# ─── سوالات دستیِ خالصِ بدون AI — دقیقاً مطابق فرم دانا + راهنمای کمک‌کننده ───
MANUAL_DIRECT_QUESTIONS: dict[str, list[dict]] = {
    "lesson": [
        {
            "key": "kn_title",
            "label": "عنوان",
            "required": True,
            "help": "عنوان کوتاه و گویا — نام تجهیز/فرایند + اقدام + نتیجه را بگو؛ از عناوین کلی مثل «تجربهٔ مهم» پرهیز کن",
        },
        {
            "key": "lesson_description",
            "label": "شرح درس‌آموخته",
            "required": True,
            "help": "شرح را در ۴ پاراگراف جدا بنویسید:\n۱) زمینه و تجهیز چه بود و کجا\n۲) چه مشکلی یا فرصتی پیش آمد\n۳) علت چه بود\n۴) چه اقدامی انجام دادید و چه درسی گرفتید",
        },
        {
            "key": "result",
            "label": "نتیجه اجرا",
            "required": True,
            "help": "نتیجهٔ واقعیِ بعد از اقدام چه شد؟ لطفاً ملموس بنویسید — اگر عدد/درصد/زمان/هزینه دارید حتماً ذکر کنید",
        },
    ],
    "suggestion": [
        {
            ...
            "label": "عنوان پیشنهاد",
            "required": True,
            "help": "عنوان کوتاهِ دقیق — نام راهکار + هدف + محل اجرا؛ مثلاً «نصب فیلتر H11 برای توربین گاز فردوسی»",
        },
        {
            "key": "current_state",
            "label": "وضع موجود",
            "required": True,
            "help": "وضعیت فعلی را کامل توصیف کنید: الان چه تجهیز/روشی استفاده می‌شود، چه مشکلی یا محدودیتی دارد و چرا این مشکل مهم است — علت و ضرورت را همین‌جا بگویید",
        },
        {
            "key": "proposal",
            "label": "پیشنهاد بهبود",
            "required": True,
            "help": "پیشنهاد را کامل و قابل اجرا توضیح دهید: چه تغییری، چگونه اجرا می‌شود، چه منابعی لازم است — در ۲-۳ پاراگراف",
        },
        {
            "key": "expected_impact",
            "label": "نتایج حاصل از اجرای پیشنهاد",
            "required": True,
            "help": "اگر اجرا شود چه اثراتی انتظار دارید؟ هر اثر را موردی بنویسید؛ اگر عدد/درصد/مبلغ قابل برآورد است حتماً ذکر کنید. توجه: این اثرِ مورد انتظار است، نه نتیجهٔ اجراشده",
        },
        {
            "key": "impact_type",
            "label": "تاثیر اجرای پیشنهاد",
            "required": True,
            "help": "نوع اثر غالب را انتخاب کنید",
            "is_button": True,
            "options": ["کیفی", "کمی"],
        },
    ],
    "explicit": [
        {
            ...
            "label": "عنوان",
            "required": True,
            "help": "عنوان دقیق منبع را کامل بنویسید — نام کتاب/مقاله/استاندارد/گزارش/لینک",
        },
        {
            "key": "description",
            "label": "توضیحات",
            "required": True,
            "help": "توضیحات کامل را بنویسید: موضوع اصلی چیست، یافته‌های کلیدی، ارزش برای سازمان — محدودهٔ کاربرد را همین‌جا بگویید",
        },
        {
            "key": "subtype",
            "label": "زیرنوع دانش صریح",
            "required": True,
            "help": "یکی را انتخاب کنید",
            "is_button": True,
            "options": ["کتاب", "محتوای آموزشی", "مقاله", "لینک", "گزارش بین‌المللی", "پادکست", "اختراع", "مجله", "استاندارد"],
        },
    ],
}
