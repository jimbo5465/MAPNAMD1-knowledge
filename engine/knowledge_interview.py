...
نکته پروژه: اگر کاربر نام نیروگاه/پروژه دیگری (مثلاً «نیروگاه پرند»، «فردوسی»، «سمنان») را به زبان آورد،
آن را دقیقاً به خاطر بسپار — در extracted_project همان نام ذکرشده را برگردان، حتی اگر با پروفایل متفاوت باشد.
...
2. اگر نام پروژه/نیروگاه در شرح اولیه یا فیلدها ذکر شده (حتی اگر با پروفایل کاربر متفاوت باشد)،
