"""
زیرمنوی «بایگانی و جستجو» — نسخه بله.
...
- بایگانی دانش: فلوهای kn:list / kn:search در bale_app/knowledge.py
"""
...
from bale_app.framework import CallbackQueryHandler, InlineKeyboardButton, InlineKeyboardMarkup
...
def get_archive_handlers() -> list[CallbackQueryHandler]:
    """هندلرهای standalone زیرمنو — در main_bale.py ثبت می‌شوند."""
    return [
